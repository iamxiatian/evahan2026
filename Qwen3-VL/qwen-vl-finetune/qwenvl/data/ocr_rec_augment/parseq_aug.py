...
from .auto_augment import _LEVEL_DENOM, LEVEL_TO_ARG, NAME_TO_OP, _randomly_negate, rotate
...
def gaussian_blur(img, radius, **__):
    radius = _get_param(radius, img, 0.05)
...
def rand_augment_transform(magnitude=5, num_layers=3):
    ...
    hparams = {
        ...
        'shear_x_pct': 0.0,
        'shear_y_pct': 0.0,
        'translate_x_pct': 0.00,
        'translate_y_pct': 0.00
    }
