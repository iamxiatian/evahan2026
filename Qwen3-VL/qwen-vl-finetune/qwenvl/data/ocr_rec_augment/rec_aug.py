...
def copy_paste(img, max_width, max_height):
    """
    Copy paste the image to the background.
    backgroud image is a white image with size of max_width and max_height.
    """
...
class SVTRAug(object):
    ...
    def __init__(self,
        ...
        self.transforms = Compose([
            ...
            SVTRDeterioration(var=10, degrees=6, factor=2, p=deterioration_p),
            CVColorJitter(
                brightness=0.5,
                contrast=0.5,
                saturation=0.5,
